	...
	<div class="wrap">
		...
		<div class="about-grid<?php echo $gallery ? '' : ' about-grid--full'; ?>">
			<div class="about-text">
				...
				<p>
					<?php esc_html_e( 'В каталоге — оборудование RIGOL, Emctestlab, Keysight, Tektronix, МигТрейдинг и Rohde & Schwarz. Помогаем подобрать модель под задачу: если нужного прибора нет в наличии или сроки не устраивают, инженер предложит аналог с сопоставимыми параметрами и назовёт реальный срок поставки.', 'amis' ); ?>
				</p>
				<p>
		...
		<div class="why-grid">
			...
			$why = array(
				array(
					...
					'text'  => __( 'RIGOL, Emctestlab, Keysight, Tektronix, МигТрейдинг и Rohde & Schwarz — подбираем модель по параметрам, а не по одному бренду.', 'amis' ),
