...
<section class="section section--head">
	<div class="wrap">
		...
		<h1><?php the_title(); ?></h1>
		<p class="page-lead">
			<?php esc_html_e( 'Оформить заказ можно на сайте или через менеджера — счёт, документы и срок поставки согласуем на этапе подтверждения заявки. Работаем с организациями по безналичному расчёту.', 'amis' ); ?>
		</p>
	</div>
</section>
