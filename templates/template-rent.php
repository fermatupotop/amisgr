...
<section class="section section--head section--dark">
	<div class="wrap">
		...
		<h1><?php the_title(); ?></h1>
		<p class="page-lead">
			<?php esc_html_e( 'Сдаём радиоизмерительное оборудование из каталога — RIGOL, МигТрейдинг, R&S, Tektronix, Keysight, Ceyear, Emctestlab — на срок от недели. Если после аренды решите оставить прибор себе, арендные платежи засчитаем в стоимость выкупа.', 'amis' ); ?>
		</p>
	</div>
</section>
