	...
	<div class="wrap">
		...
		<div class="about-grid<?php echo $gallery ? '' : ' about-grid--full'; ?>">
			<div class="about-text">
				...
				<p>
					<?php esc_html_e( 'Кроме продажи — поверка и калибровка в аккредитованном ЦСМ, аренда приборов на проект, демо-образец на тест перед покупкой и trade-in старого парка. Работаем по 44-ФЗ и 223-ФЗ, оформляем полный пакет документов для тендеров и бухгалтерии.', 'amis' ); ?>
				</p>
	...
	<div class="wrap">
		...
		<div class="why-grid">
			...
			$why = array(
				...
				array(
					'title' => __( 'Демо, аренда, trade-in', 'amis' ),
					'text'  => __( 'Отправляем прибор на тест на 14 дней, сдаём в аренду с зачётом в выкуп, принимаем старый парк по trade-in.', 'amis' ),
