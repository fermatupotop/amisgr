			...
			<div class="f-col">
				...
				<div class="f-group">
					...
					<ul class="f-links">
						...
						<li><a href="<?php echo esc_url( home_url( '/delivery/' ) ); ?>"><?php esc_html_e( 'Условия доставки', 'amis' ); ?></a></li>
						<li><a href="<?php echo esc_url( home_url( '/payment/' ) ); ?>"><?php esc_html_e( 'Оплата для юридических лиц', 'amis' ); ?></a></li>
